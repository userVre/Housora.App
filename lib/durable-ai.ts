...
export async function enqueueAi(args: { ownerId: string; type: "segment" | "edit"; requestId: string; inputHash: string; image: string; mask?: string; prompt?: string; mode?: string; aspectRatio?: string }) {
